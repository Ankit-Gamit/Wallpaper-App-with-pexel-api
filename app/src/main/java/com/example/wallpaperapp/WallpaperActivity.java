...
public class WallpaperActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageView = findViewById(R.id.wallpaperActivityImgView);
        Button button = findViewById(R.id.btnSetWallpaper);
        progressBar=findViewById(R.id.progBarWallpaper);
        Button save = findViewById(R.id.btnSaveWallpaper);
